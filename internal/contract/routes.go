...
var Routes = []Route{
	...
	{Method: "GET", Path: "/sitemaps/static.xml", Surface: SurfaceOperational},
	{Method: "GET", Path: "/sitemaps/:kind/:page", Surface: SurfaceOperational},
	...
	{Method: "GET", Path: "/review/:id", Surface: SurfacePublicPage},
	{Method: "GET", Path: "/list", Surface: SurfacePublicPage},
	{Method: "GET", Path: "/list/:slug", Surface: SurfacePublicPage},
	...
	{Method: "GET", Path: "/feed", Surface: SurfaceDashboard},
	{Method: "GET", Path: "/following", Surface: SurfaceDashboard},
	{Method: "DELETE", Path: "/api/users/:user_id/follow", Surface: SurfaceHTMX},
	{Method: "POST", Path: "/api/users/:user_id/follow", Surface: SurfaceHTMX},
	...
	{Method: "GET", Path: "/api/htmx/movie-ready", Surface: SurfaceHTMX},
	{Method: "GET", Path: "/api/htmx/movie-actions", Surface: SurfaceHTMX},
	{Method: "GET", Path: "/api/htmx/movie-playback", Surface: SurfaceHTMX},
	{Method: "GET", Path: "/api/htmx/movie-series", Surface: SurfaceHTMX},
	...
	{Method: "GET", Path: "/api/htmx/watch-actions", Surface: SurfaceHTMX},
	{Method: "GET", Path: "/api/htmx/watch-schedule", Surface: SurfaceHTMX},
	...
	{Method: "POST", Path: "/admin/data/media-task", Surface: SurfaceAdmin},
	...
	{Method: "GET", Path: "/admin/collections", Surface: SurfaceAdmin},
	{Method: "POST", Path: "/admin/collections", Surface: SurfaceAdmin},
	{Method: "DELETE", Path: "/admin/collections/:id", Surface: SurfaceAdmin},
	{Method: "GET", Path: "/admin/filters", Surface: SurfaceAdmin},
	{Method: "POST", Path: "/admin/filters", Surface: SurfaceAdmin},
	{Method: "PUT", Path: "/admin/filters/:id", Surface: SurfaceAdmin},
	{Method: "DELETE", Path: "/admin/filters/:id", Surface: SurfaceAdmin},
}
