...
var RequestInputs = []RequestInput{
	...
	{Method: "POST", Path: "/auth/register", Name: "is_public", Location: InputForm},
	{Method: "GET", Path: "/feed", Name: "page", Location: InputQuery, Default: "1"},
	{Method: "GET", Path: "/following", Name: "page", Location: InputQuery, Default: "1"},
	{Method: "GET", Path: "/list", Name: "page", Location: InputQuery, Default: "1"},
	{Method: "GET", Path: "/admin/collections", Name: "edit", Location: InputQuery},
	{Method: "GET", Path: "/admin/collections", Name: "notice", Location: InputQuery},
	{Method: "GET", Path: "/admin/collections", Name: "error", Location: InputQuery},
	{Method: "GET", Path: "/admin/collections", Name: "unknown", Location: InputQuery},
	{Method: "POST", Path: "/admin/collections", Name: "id", Location: InputForm},
	{Method: "POST", Path: "/admin/collections", Name: "title", Location: InputForm},
	{Method: "POST", Path: "/admin/collections", Name: "slug", Location: InputForm},
	{Method: "POST", Path: "/admin/collections", Name: "description", Location: InputForm},
	{Method: "POST", Path: "/admin/collections", Name: "items", Location: InputForm},
	{Method: "POST", Path: "/admin/collections", Name: "featured", Location: InputForm},
	...
	{Method: "GET", Path: "/api/htmx/movie-ready", Name: "douban_id", Location: InputQuery},
	{Method: "GET", Path: "/api/htmx/movie-actions", Name: "douban_id", Location: InputQuery},
	{Method: "GET", Path: "/api/htmx/movie-actions", Name: "media_id", Location: InputQuery},
	{Method: "GET", Path: "/api/htmx/movie-actions", Name: "title", Location: InputQuery},
	{Method: "GET", Path: "/api/htmx/movie-actions", Name: "poster", Location: InputQuery},
	{Method: "GET", Path: "/api/htmx/movie-actions", Name: "year", Location: InputQuery},
	{Method: "GET", Path: "/api/htmx/movie-playback", Name: "douban_id", Location: InputQuery},
	{Method: "GET", Path: "/api/htmx/movie-playback", Name: "media_id", Location: InputQuery},
	{Method: "GET", Path: "/api/htmx/movie-playback", Name: "title", Location: InputQuery},
	{Method: "GET", Path: "/api/htmx/movie-playback", Name: "search_title", Location: InputQuery},
	{Method: "GET", Path: "/api/htmx/movie-playback", Name: "year", Location: InputQuery},
	{Method: "GET", Path: "/api/htmx/movie-series", Name: "douban_id", Location: InputQuery},
	{Method: "GET", Path: "/api/htmx/watch-actions", Name: "douban_id", Location: InputQuery},
	{Method: "GET", Path: "/api/htmx/watch-actions", Name: "title", Location: InputQuery},
	{Method: "GET", Path: "/api/htmx/watch-actions", Name: "poster", Location: InputQuery},
	{Method: "GET", Path: "/api/htmx/watch-actions", Name: "year", Location: InputQuery},
	{Method: "GET", Path: "/api/htmx/watch-actions", Name: "redirect", Location: InputQuery},
	{Method: "GET", Path: "/api/htmx/watch-schedule", Name: "douban_id", Location: InputQuery},
	...
	{Method: "GET", Path: "/admin/data", Name: "q", Location: InputQuery},
	{Method: "GET", Path: "/admin/data", Name: "media_id", Location: InputQuery},
	{Method: "POST", Path: "/admin/data/media-task", Name: "media_id", Location: InputForm},
	{Method: "POST", Path: "/admin/data/media-task", Name: "action", Location: InputForm},
	...
	{Method: "POST", Path: "/admin/filters", Name: "keyword", Location: InputForm},
	{Method: "POST", Path: "/admin/filters", Name: "block_ingest", Location: InputForm},
	{Method: "POST", Path: "/admin/filters", Name: "copyright_restricted", Location: InputForm},
	{Method: "POST", Path: "/admin/filters", Name: "sensitive", Location: InputForm},
	{Method: "PUT", Path: "/admin/filters/:id", Name: "keyword", Location: InputForm},
	{Method: "PUT", Path: "/admin/filters/:id", Name: "block_ingest", Location: InputForm},
	{Method: "PUT", Path: "/admin/filters/:id", Name: "copyright_restricted", Location: InputForm},
	{Method: "PUT", Path: "/admin/filters/:id", Name: "sensitive", Location: InputForm},
}
